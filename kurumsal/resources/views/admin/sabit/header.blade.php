                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="{{ (!empty(Auth::user()->resim)) ? url('upload/admin/'.Auth::user()->resim) : url('upload/resim-yok.png') }}" alt="">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('login') }}" class="btn header-item waves-effect">
                                <i class="ri-login-box-line align-middle me-1"></i> Giris Yap
                            </a>
                            @endauth
                        </div>
